...
const Register = () => {
  ...
  const handleValidation = async (e) => {
    ...
    if (data.firstName === "") {
      toast.error("please enter  firstName", toastOptions);
      return;
    }
    if (data.lastName === "") {
      toast.error("please enter lastName", toastOptions);
      return;
    }
    if (data.email === "") {
    ...
    if (data.accountType === "") {
      toast.error("please select a accountType", toastOptions);
      return;
    }
    handleSubmission();
  };
      ...
      <div class="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
        ...
        <div className="w-full  bg-gray-100 lg:w-1/2 flex items-center justify-center ">
          <form
            ...
            className="bg-white  shadow rounded max-w-md w-full p-6"
          >
            <p
              tabIndex={0}
              role="heading"
            ...
            <p className="text-sm mt-4 font-medium leading-none text-gray-500 ">
              ...
              <Link
                to="/login"
                className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer animate-bounce"
              >
                Log in here
              </Link>
            </p>
