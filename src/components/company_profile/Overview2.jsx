    ...
    if (c_id) {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_APP_BASE_URL}/company/${c_id}`
        );
  ...
  const handleCompanySubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `${import.meta.env.VITE_APP_BASE_URL}/company/updateCompany`,
        companyFormData
      );
        ...
        <div className="bg-white   p-2  w-full ">
          ...
          <div >
            ...
            <div className="flex text-sm w-fit text-gray-500 mt-1 gap-1">
              <NavLink to={'/'} className="cursor-pointer hover:text-slate-800">Home</NavLink>
              <span>|</span>
              <NavLink to={'/app/companyProfile'} className="cursor-pointer hover:text-slate-800">Company Profile</NavLink>
              <span>|</span>
              <span className="cursor-default text-gray-500 hover:text-slate-800">Overview</span>
            </div>

            <hr className="my-4  border-gray-300" />

            <div className="bg-slate-50 shadow-md rounded-md p-4 border">
              {edit ? (
                <form onSubmit={handleCompanySubmit} className="space-y-4">

                {/* heading */}
                  <div className=" bg-white flex mb-3 w-full pr-2 justify-between items-center  shadow-md  border-gray-490 rounded-md border">
                    ...
                    >
                      <MdOutlineEdit size={28} className="cursor-pointer hover:bg-gray-100 active:bg-gray-200 rounded-full p-1 text-gray-700"  />
                    </div>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 2xl:grid-cols-3">
                      ...
                      <div className="flex flex-col ">
                        <label
                          ...
                          className="text-md font-bold text-gray-700 py-2 "
                        >
                  ...
                  <div>
                    <div>
                      ...
                      <div  className="">
                        <h1 className="bg-white text-xl font-bold text-slate-700 my-3  p-1 border shadow-md rounded-md">
                          Registered Office Address
                        </h1>
                      ...
                      <div className="">
                        <h1 className="text-xl font-bold text-black my-4 p-1 border shadow-md rounded-md bg-white ">
                          Corporate Office Address
                        </h1>
                ...
                <div>
                 {/* heading */}
                  <div className="flex  w-full pr-2 justify-between items-center  shadow-md  border-gray-490 rounded-md border bg-white mb-3">
                    <h1 className="text-xl font-bold p-1 ">
                      Profile
                    </h1>
                    <div
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 2xl:grid-cols-3 my-2">
                  ...
                  {/* heading */}
                      <h1 className="text-xl font-bold text-black my-2  mb-3 p-1 border shadow-md rounded-md bg-white">
                        Registered Office Address
                      </h1>
                    ...
                    <div className="flex flex-col ">
                      <h1 className="text-xl font-bold text-black my-3  p-1 border shadow-md rounded-md bg-white">
                        Corporate Office Address
                      </h1>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 2xl:grid-cols-3">
            ...
            <div className="bg-slate-50  rounded-md shadow-md  ">
              {!edit2 ? (
                <div className="flex flex-col gap-2 px-4 py-2 ">
                  <div className=" flex w-full justify-between items-center border shadow-md rounded-md bg-white">

                    <h1 className="text-xl font-bold  my-1 px-2  ">
                      Social Media
                    </h1>
                  ...
                  <div className="grid grid-cols-2 max-sm:grid-cols-1 space-y-4 p-1  ">
                ...
                <div className="flex flex-col gap-2 px-4 py-2 w-full ">
                  ...
                  <div className=" flex w-full justify-between items-center border shadow-md rounded-md bg-white">
                    ...
                    <h1 className="text-xl font-bold text-slate-700 py-1 px-2 ">
                      Social Media
                    </h1>
                  ...
                  <form onSubmit={handleSocialMediaSubmit} className="mt-2 " >
                    <div className=" grid grid-cols-2 2xl:grid-cols-3 max-sm:grid-cols-1">
                      <div className="flex flex-row justify-start items-center m-2 ml-1 ">
                        <div className="text-3xl text-blue-700 text-center">
                          <ImLinkedin />
                        </div>

                        <input
                          className="border  py-1.5 border-gray-200 w-full ml-4 rounded-md px-3 focus:outline-none"
                          type="url"
                          name="linkedinUrl"
                    ...
                    {editMode && (
                      <div className="h-[100px] flex flex-row items-center justify-end">
