...
const Promotion = () => {
    ...
    return (
        <div className="p-6 pt-0 md:p-10 font-serif max-w-lg lg:max-w-3xl mx-auto bg-white shadow-md rounded-lg">
            ...
            <p className="h-4 md:h-8 mb-3 text-sm md:text-base mt-4"> <b className='underline'>Sub:</b> Approval for a leave of absence due to illness.
            </p>
            ...
            <Section>
                ...
                <p className="text-sm md:text-base pt-6">
                    We have received your leave request due to illness to be exempt from the office from <Placeholder className="font-bold" label="(Insert dates)" />.
                </p>
            </Section>
            <Section>
                <p className="text-sm md:text-base ">This letter serves as a confirmation that your request for the leave has been accepted. We value your
                    services at INFINITALENT CONSULTING PRIVATE LIMITED, and we wish you a speedy recovery.
                    We hope that you will be available in case of an emergency.
                </p>
            </Section>
          

           
            <p className="text-sm md:text-base mt-4">Warm Regards,</p>
