...
const Delay = () => {
    ...
    return (
        <div className="p-6 pt-0 md:p-10 font-serif max-w-lg lg:max-w-3xl mx-auto bg-white shadow-md rounded-lg">
            ...
            <p className="h-4 md:h-8 mb-3 text-sm md:text-base mt-4"> <b className='underline'>Sub:</b>  Delay in the salary for the month of <Placeholder className='font-bold' label="(Insert Month)" />.

            </p>


            <Section>
                <p className='pt-7 text-sm md:text-base'>Dear Chandrappa,</p>
                <p className="text-sm md:text-base pt-6">
                    We are writing this letter to inform you that resentfully, the payment towards your salary for the month of
                    <Placeholder className='font-bold' label="(Insert Month)" /> will be delayed. This delay is due to <Placeholder className='font-bold' label="(Insert Reason)" />.

                </p>
            </Section>
            <Section>
                <p className="text-sm md:text-base ">We regret this inevitable situation and hope you will cooperate with us to rise to better standards. Your
                salary will be credited no later than <Placeholder className='font-bold' label="(Date)" />
                </p>
            </Section>
