...
const Increment = () => {
    ...
    const [newCTC, setNewCTC] = useState("_____");
    ...
    return (
        <div className="p-6 pt-0 md:p-10 font-serif max-w-lg lg:max-w-3xl mx-auto bg-white shadow-md rounded-lg">
            ...
            <p className="h-4 md:h-8 mb-3 text-sm md:text-base mt-4">
                <b className='underline'>Notice:</b> Increment in Salary.
            </p>

            <Section>
                <p className='pt-2 text-sm md:text-base'>Dear {employeeName},</p>
                <p className="text-sm md:text-base pt-6">
                    On behalf of everyone at INFINITALENT CONSULTING PRIVATE LIMITED, I would like to appreciate your work over the past few months. The countless number of hours and efforts that you have put in over the period of time haven't been overlooked, and I would like to appreciate your exemplary services. As a result of your exceptional performance, we have decided to increase your pay to 
                    <input
                        type="text"
                        value={newCTC}
                    ...
                    /> per annum. I sincerely hope that this increment will be a good reflection of your worth to the company.
                </p>
            </Section>

            <Section>
                <p className="text-sm md:text-base">
                    Seeing your diligence, focus, and desire to achieve results has been a source of motivation for the whole team, and we hope that this positivity flows into every day of work.
                </p>
            </Section>

            <Section>
                <p className="text-sm md:text-base">Thank you once again for all your effort.</p>
            </Section>

            <p className="text-sm md:text-base">Yours Truly,</p>
