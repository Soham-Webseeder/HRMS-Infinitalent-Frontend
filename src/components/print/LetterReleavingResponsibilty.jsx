    ...
    return (
        <div className="p-6 md:p-10 font-serif max-w-lg lg:max-w-3xl mx-auto bg-white shadow-md rounded-lg relative">
            ...
            <p className="h-4 md:h-8 mb-3 text-sm md:text-base mt-4">
                <b className='underline'>Sub:</b> Reducing your responsibilities as a MD/CEO.
            </p>

            <div className="mb-6 md:mb-8">
                <p className='text-sm md:text-base pt-7'>
                    Dear <input
                        type="text"
                        className="underline"
                        value={recipientName}
                ...
                <p className="text-sm md:text-base pt-6">
                    A few weeks ago, we had observed your work and your performance was excellent, which is why we had
                    decided to give you the additional responsibility of <space/><input
                        type="text"
                        className="underline font-bold"
                        value={responsibility}
                        onChange={(e) => setResponsibility(e.target.value)}
                        ref={responsibilityInputRef}
                        style={{ overflow: 'hidden', width: '12ch', minWidth: '50px' }}
                    />. However, ever
                    since you have taken this challenge on, we have seen a significant drop in your performance. We
                    appreciate your commitment and dedication towards your job, but we think that you performing your
                    original duties well is much more important than the additional responsibilities given to you later on.
                </p>
            </div>

            <div className="mb-6 md:mb-8">
                <p className="text-sm md:text-base">
                    Hence, we have decided that we are going to relieve you from <input
                        type="text"
                        className="underline font-bold"
                        value={responsibility}
                        onChange={(e) => setResponsibility(e.target.value)}
                    ...
                    /><space/> w.e.f. <input
                        ...
                        ref={reliefDateInputRef}
                        style={{ overflow: 'hidden', width: 'ch', minWidth: '0px' }}
                    />. We hope that this boosts your performance levels and restores your results.
                </p>
