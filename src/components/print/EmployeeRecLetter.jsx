...
const Designation = () => {
    ...
    return (
        <div className="p-6 pt-0 md:p-10 font-serif max-w-lg lg:max-w-3xl mx-auto bg-white shadow-md rounded-lg">
            ...
            <div className='space-y-4 pt-0 text-sm md:text-base '>
            ...
            <p className="h-4 md:h-8 mb-3 text-sm md:text-base mt-4"> <b className='underline'>Sub:</b> Employment Recognition Letter.</p>
            ...
            <Section>
                ...
                <p className="text-sm md:text-base pt-6">
                    ...
                    appreciate your work over the past <Placeholder className='font-bold' label="(Insert Duration)"/>. The endless hours you have put in your
                    assignment and the steadiness that you have shown in your results has left the entire team in awe and we
                    deem ourselves lucky to have had you on board.
                </p>
            </Section>
            <Section>
                <p className="text-sm md:text-base ">Seeing your diligence and focus has been a source of motivation for the whole team, and we hope that this
positivity flows into every day of work. <p/>
                </p>
            </Section>
            

            <p className="text-sm md:text-base ">Yours Truely,</p>
