...
const Increment = () => {
    ...
    return (
        <div className="p-6 pt-0 md:p-10 font-serif max-w-lg lg:max-w-3xl mx-auto bg-white shadow-md rounded-lg">
            ...
            <p className="h-4 md:h-8 mb-3 text-sm md:text-base mt-4"> <b className='underline'>Sub:</b> Increment in Salary.</p>
            ...
            <Section>
                ...
                <p className="text-sm md:text-base pt-6">
                    ...
                    appreciate your work in your probationary period. The countless number of hours and efforts that you
                    have invested over the period of time haven't gone unnoticed and I would like to thank you for your
                    extraordinary services. As a result of your exemplary performance, we have decided to increase your pay
                    to <Placeholder className='font-bold' label='(CTC)' /> per annum. I sincerely hope that this increment will be a good reflection of your
            ...
            <Section>
                <p className="text-sm md:text-base ">Seeing your diligence, focus and desire to work has been a source of motivation for the whole team, and
