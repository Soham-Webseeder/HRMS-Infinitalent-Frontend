...
const Promotion = () => {
    ...
    return (
        <div className="p-6 pt-0 md:p-10 font-serif max-w-lg lg:max-w-3xl mx-auto bg-white shadow-md rounded-lg">
            ...
            <p className="h-4 md:h-8 mb-3 text-sm md:text-base mt-4"> <b className='underline'>Sub:</b> Warning Letter for inadequate performance.
            </p>


            <Section>
                <p className='pt-6 text-sm md:text-base'>Dear Chandrappa,</p>
                <p className="text-sm md:text-base pt-6">
                    We have been monitoring your performance, and it has been observed that your performance during the
                    past <Placeholder className='font-bold ' label="(Insert Duration)" /> has not been satisfactory. We have given you several verbal warnings,
                    and few suggestions to help enhance your performance too, but we haven't seen appreciable
                    improvements since.

                </p>
            </Section>
            <Section>
                <p className="text-sm md:text-base ">Hence, we are writing to you to notify you that if your performance doesn't improve in the forthcoming
                    weeks, we will have to take serious action. You can consider this an official warning.
                </p>
                <p className='mt-5 text-sm md:text-base'>Hoping to see an improvement in your work.</p>
                <p className='mt-5'>Sincerely</p>

            </Section>

            <p className=' text-sm md:text-base  pb-72'>For INFINITALENT CONSULTING PRIVATE LIMITED</p>
